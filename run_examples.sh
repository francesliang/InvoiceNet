...
### Training
docker run -it -v $(pwd):/InvoiceNet invoicenet:1.0.0 /bin/bash -c "python3 /InvoiceNet/train.py --data_dir /InvoiceNet/processed_data/ --batch_size 1 --field total_amount --steps 50 --model_dir test_models"
